...
| Key                              | Default        | Description                                                                                                  |
| -------------------------------- | -------------- | ---------------------------------------------------------------------------------------------------------- |
| `default_device`                 | `"auto"`       | Device used for AI processing: `"auto"` (pick the best available, including Apple Metal), `"cpu"`, or `"cuda"` (NVIDIA, and AMD via ROCm; `"gpu"` is an alias). |
