- The Recipe tab now says *why* a picture's recipe cannot be run again instead
  of offering a button that would fail. **Generate variants…** stays in place,
  disabled, with the reason beside it — and the reasons are told apart: a
  picture made in A1111 or Forge has no ComfyUI graph to replay, a graph may
