...
- **`?topology=<hash>` is honoured here**, as it was on the shelf: the link a
  ...
  **It can only reach the cards the grid lists, and that is not every card.**
  ...
  actionable: unticking *Hide one-offs*, or ticking *Hidden workflows*,
