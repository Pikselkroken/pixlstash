...
- **On disk in the destination folder, not in a hub store and not in a new
  ...
  own stem — `JimmyBuss.safetensors` → `JimmyBuss_samples/`,
  `JimmyBuss_0001500.safetensors` → `JimmyBuss_0001500_samples/` — holding
