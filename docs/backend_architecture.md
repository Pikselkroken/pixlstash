...
field named like a credential is dropped, which is what makes the plan's §5
deletion boundary real rather than aspirational — "forget the pictures" purges
instances and ghosts and leaves the recipe standing, with no purge having to
reach in and rewrite a stored graph. It is also why this row cannot be handed
