...
> nobody has to reformat a volume to learn them again.
> `pixlstash/services/views_service.py`, the code this describes, no longer
> exists; read the numbers, not the API.
