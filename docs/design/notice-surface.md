...
| `ImageOverlay .overlay-comfy-error` | `rgba(error, .2)` on the lightbox | 12.92 / 13.89 | 12.92 / **1.24** | same (9.89 / 11.24) | *(the rule still stands; the class itself went with the lightbox's I2I menu in #1406)*
