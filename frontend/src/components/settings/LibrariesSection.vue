...
// `Caption files…` is the same shape: the routes address the open library.
const captionsDialogOpen = ref(false);
...
<template>
  <div class="libraries-pane">
    ...
    />
    <LibraryCaptionsDialog
      :open="captionsDialogOpen"
      @close="captionsDialogOpen = false"
    />
