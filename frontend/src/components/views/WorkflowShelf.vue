...
// inspector (§F3: how each picture input is filled). Naming a workflow and
// running one are later steps, and forgetting ghosts is a purge in Settings ›
// Privacy; the row menu offers only what can be read today. The Ghosts toggle
// beside Group / Sort / Show narrows the list to what those purges would reach.
